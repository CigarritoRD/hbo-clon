...
const Footer = () => {
  return (
    <div className=' font-medium gap-2 text-[#9e86ff] flex flex-col justify-center items-center bg-gradient-to-b from-black/80 via-black/60 to-black/80 bg-blue-800 py-8'>
